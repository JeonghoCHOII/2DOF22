...
export default class Simulation {
    constructor() {
        ...
        this.worker = new Worker('js/physics.worker.js', { type: 'module' }); // 경로, 환경 맞춰 조정
        this.worker.onmessage = (e) => this.onWorkerMessage(e);
        // physics 인스턴스 필요 없음
        this.renderer = new Renderer(this.ui.contexts, this.ui.canvases, this.physicsForRender); // physics argument는 null 또는 삭제
