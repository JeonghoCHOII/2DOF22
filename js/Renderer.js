...
function getGrid(cols, rows, q1min, q2min, q1max, q2max, potential, x) {
...
function drawSpace(ctx, G_SCALE = 100, WIDTH = 600, HEIGHT = 600) {
...
export function drawLayer14(layer1, layer4, x, G_SCALE = 100, WIDTH = 600, HEIGHT = 600) {
    drawSpace(layer1, G_SCALE = 100, WIDTH = 600, HEIGHT = 600);
    addLine(layer1, WIDTH, HEIGHT);
    axisName(layer1, WIDTH = 600, HEIGHT = 600);
    drawLegend(layer4, WIDTH = 600)
}